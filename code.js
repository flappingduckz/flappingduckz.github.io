...
function openPopUpForecast(e) {
    ...
    while (g < 5) {
        ...
        console.log(g + 'is')
        document.getElementById(`ForeCastCard${g}`).style.backgroundColor = `rgba(241, 241, 241, 0.551)`;
...
function closePopUpForecast(e) {
    ...
    document.getElementById(`ForeCastCard${e.value}`).style.backgroundColor = `rgba(241, 241, 241, 0.551)`
